...
class SeatedTheatreAdapter(
    private val theatreList: List<DatabaseHelper.Theatre>
) : RecyclerView.Adapter<SeatedTheatreAdapter.SeatedTheatreViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SeatedTheatreViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            val intent = Intent(context, TheatreSeatStructureActivity::class.java).apply {
